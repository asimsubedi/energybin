...
<div class="container">
    <div class="row">
        <div class="col-md-9 col-sm-8">
            ...
            <p class="lead">This is the Sample question we are going to answer?</p>
            ...
            <hr>
            <p class="lead">What is actually the earth saving campaign?</p>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptates ratione odit recusandae id, atque at labore maiores veritatis deserunt? Beatae cum cumque saepe dolorum fugit error quidem suscipit provident repellat.Lorem ipsum dolor sit amet, consectetur adipisicing elit. Similique fugit quidem laborum minima maxime quis delectus ullam cumque quisquam tempora quod incidunt sunt distinctio, eveniet rem odio. Aut, illum, quis.Lorem ipsum dolor sit amet, consectetur adipisicing elit. Id officiis eligendi aperiam doloremque, maiores recusandae mollitia possimus necessitatibus itaque quidem quam perferendis dolore, praesentium, qui repudiandae ea sed vitae totam.</p>
            <hr>
            <p class="lead">This is the Sample question we are going to answer?</p>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad tempore quod eum animi et eos beatae ab, natus aliquam. Voluptate hic ipsum consequatur, repellendus quia architecto praesentium, blanditiis nisi adipisci.Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eaque deleniti natus nostrum voluptate, tempore assumenda accusamus quae exercitationem illo perferendis. Aut temporibus rem nesciunt inventore nobis iure et velit molestias.Lorem ipsum dolor sit amet, consectetur adipisicing elit. Saepe doloremque dolorem perspiciatis dignissimos dolore, error voluptate explicabo, voluptatibus dolorum accusamus officiis! Distinctio fugiat necessitatibus obcaecati, quo error eligendi dolorem soluta.</p>
            <hr>
        ...
        <?php include_once('includes/include-sidebar.php'); ?>
    </div>
</div>
